print('NAME: SHARIFF SULEIMAN MARAFA FROM COMPUTER SCIENCE DEPT.\n MATRIC NUMBER:U19/FNS/CSC/1104')
print("WELCOME TO UBA USSD TRANSACTION")
# 	ussd_code = int(input("Enter ussd code here: "))
def back():
	if len(pin) == 4:
		print('your Account Balance is',balance,'Naira')
while True:
	Account_name = ['SHARIFF MARAFA']
	Account_number = []
	Account_pin = 1414
	balance = 7500000
	...
	if ussd_code == '*919#':
		...
		if option == 1:
			...
			pin = input('Enter your pin')
			if len(pin) ==4:
				print('your account bal: 5000000')
			break
		elif option== 7:
			pin = input('Enter your pin')
			if len(pin) ==4:
